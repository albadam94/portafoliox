...
<a href="https://www.facebook.com/albadam94" target="_blank" rel="noopener noreferrer"><img className='ml-10 md:ml-24' src={Facebook} alt="facebook" /></a>
<a href="https://www.instagram.com/albadam94" target="_blank" rel="noopener noreferrer"><img className='ml-4' src={Instagram} alt="instagram"/> </a>
<a href="https://www.twitter.com/albadam94" target="_blank" rel="noopener noreferrer"><img className='ml-4' src={Twitter} alt="twitter" /></a>
<a href="https://www.behance.net/brayanalbadam" target="_blank" rel="noopener noreferrer"><img className='ml-4 mt-2' src={Behance} alt="behance" /></a>
...
<div className=' text-gray-200 ml-1  md:ml-40 text-left'>
<table>
  <tbody>
    <tr>
      <td className='px-2 md:px-6 py-4'>Tecnologo Producción Multimedia</td>
      <td className='px-1 py-5 md:px-6 '>Diplomado programación, Desarrollo de software con enfasis en aplicaciones web<br></br>
    ...
    <tr>
      <td className='px-2 md:px-6 py-4'>Curso diseño de marca | Crehana</td>
    ...
    <tr>
      ...
      <td className='px-1 py-4 md:px-6 '>Aplicación del marco de trabajo SCRUM para proyectos de desarrollo de software | SENA</td>
    </tr>
  </tbody>
</table>
</div>
...
<div className='  text-gray-200 relative overflow-x-auto ml-2 md:ml-40 text-left '>
<table>
  <tbody>
    <tr>
