    ...
    <nav className='menu mt-0 sticky top-0 z-50 p-4  bg-inherit'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='flex justify-between items-center h-16'>
          ...
          <div className="bg-Darkcharcoal py-3 px-10 rounded-3xl md:items-center hidden sm:block sm:ml-6 md:ml-60 items-center space-x-6 sm:space-x-9 font-['Geist']" >
            <Link href='/' legacyBehavior>
          ...
          <div className='hidden sm:block sm:ml-6 space-x-4'>
            <a href='mailto:brayanalbadam@gmail.com' legacyBehavior>
              <button className="text-white bg-Darkcharcoal px-3 py-3 text-sm font-semibold font-['Geist'] leading-none w-[110.23px] h-10 rounded-3xl border ">
                Contacto
              </button>
            </a>
            <a
            ...
            >
              <button className="text-cyan-500 bg-Darkcharcoal py-3  text-sm font-semibold font-['Geist'] leading-none w-[110.23px] h-10 md:w-36 rounded-3xl border  mr-4">
                Descargar CV
              </button>
            </a>
          </div>
