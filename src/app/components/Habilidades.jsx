...
const Habilidades = () => {
  return (
    <div className="mt-16 md:mt-32 px-4">
      ...
      <h1 className="text-custom-blue text-5xl font-semibold leading-[56px] md:mx-auto lg:mx-20 xl:mx-36 font-['Outfit'] mt-10 ">Habilidades</h1>
      ...
      <h1 className="text-custom-blue text-5xl font-semibold leading-[56px] md:mx-auto lg:mx-20 xl:mx-36 font-['Outfit'] mt-20 md:mt-10 ">Stack</h1>
    </div>
  );
};
