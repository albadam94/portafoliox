...
const Experiencia = () => {
  return (
    <>
      <h1 className="text-custom-blue text-5xl font-semibold leading-[56px] md:mx-auto lg:mx-20 font-['Geist'] mt-10 xl:mx-[-120px]">
        Experiencia
      </h1>
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        <div className="grid grid-cols-1 md:grid-cols-1 gap-6 font-['Geist'] mt-20">
          <Accordion 
            ...
            style={{ boxShadow: "0 1px 2px 0 rgba(60, 64, 67, 0.30), 0 1px 3px 1px rgba(60, 64, 67, 0.15)" }}
          >
            <AccordionItem className="font-medium" key="5" title={<span style={{ color: '#083040' }}>Diseñador UX/UI-Desarrollador Frontend</span>} subtitle="We Are Angular" aria-label="UX Engineer">
              <p className="text-sm text-Darkcharcoal font-normal">
                ...
                Realicé los diseños de UX Flow, UX Task, casos de uso del sistema PRM de aprendizaje y de cada uno de los cursos y brinde apoyo en el diseño UI en la creación de banners y demas elementos visuales.<br /><br />
            ...
            <AccordionItem className="font-medium" key="7" title={<span style={{ color: '#083040' }}>Freelance</span>} subtitle="Independiente" aria-label="Freelance">
              <p className="text-sm text-Darkcharcoal font-normal">
                ...
                Diseño UX/UI de la app web Playme del sector entretenimiento de contenidos, Diseño de flujos, diseño UI, UI KIT, diseño de componentes, diseño de banners, diseño paginas de perfil, pagina de carga de contenidos, diseño de dashboard de estadísticas y pagos. 
                <a 
                  href="https://playme.us" 
                  target="_blank"
                  rel="noopener noreferrer" 
                  className="text-sky-400 font-bold underline"
                > Proyecto playme.us</a>
              </p>
            </AccordionItem>
