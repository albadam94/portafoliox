        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-6 font-['Geist'] mt-20">
          ...
          >
            <AccordionItem
              ...
              key="1"
              title={<span style={{ color: "#083040" }}>Profesional en Diseño Digital</span>}
              subtitle="Universidad Politécnico GranColombiano"
            ...
            <AccordionItem
              className="font-medium"
              key="2"
              title={<span style={{ color: "#083040" }}>Tecnólogo producción multimedia</span>}
              subtitle="SENA"
              aria-label="Tecnólogo en producción multimedia"
            >
              <p className="text-sm text-Darkcharcoal font-normal">
            ...
            <AccordionItem
              className="font-medium"
              key="3"
              title={<span style={{ color: "#083040" }}>Diplomado programación, Desarrollo de software con énfasis en aplicaciones web</span>}
              subtitle="Universidad Industrial de Santander"
            ...
            <AccordionItem
              className="font-medium"
              key="4"
              title={<span style={{ color: "#083040" }}>Certificado profesional diseño de experiencia de usuario UX Google</span>}
            ...
            <AccordionItem
              className="font-medium"
              key="5"
              title={<span style={{ color: "#083040" }}>Diseño de experiencia de usuario y consumidor UX-CX</span>}
            ...
            <AccordionItem
              className="font-medium"
              key="6"
              title={<span style={{ color: "#083040" }}>Ver más</span>}
              aria-label="Ver más"
            >
              <p className="text-sm text-Darkcharcoal font-normal">
