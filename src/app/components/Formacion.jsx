    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 gap-6 font-['Geist'] mt-20">
        ...
        <AccordionItem className="font-medium"  key="1" title={<span style={{ color: '#083040' }}>Profesional en Diseño Digital</span>}subtitle="Universidad Politécnico GranColombiano" aria-label="Profesional en Diseño Digital">
          ...
          <AccordionItem className="font-medium"  key="3" title={<span style={{ color: '#083040' }}>Diplomado programación, Desarrollo de software con énfasis en aplicaciones web</span>} subtitle="Universidad Industrial de Santander" aria-label="Diplomado programación, Desarrollo de software con énfasis en aplicaciones web">
            <p className="text-sm text-Darkcharcoal font-normal">
          ...
          <AccordionItem className="font-medium"  key="4" title={<span style={{ color: '#083040' }}>Certificado profesional diseño de experiencia de usuario UX Google</span>}subtitle="Coursera-Google" aria-label="Certificado profesional diseño de experiencia de usuario UX Google">
            <p className="text-sm text-Darkcharcoal font-normal">
          ...
          <AccordionItem className="font-medium"  key="5" title={<span style={{ color: '#083040' }}>Diseño de experiencia de usuario y consumidor UX-CX</span>}subtitle="Universidad San Buenaventura" aria-label="Diseño de experiencia de usuario y consumidor UX-CX">
            <p className="text-sm text-Darkcharcoal font-normal">
          ...
          <AccordionItem className="font-medium" key="6" title={<span style={{ color: '#083040'  }}>Ver más</span>} aria-label="Ver más">
            <p className="text-sm text-Darkcharcoal font-normal">
