...
export default function App() {
  ...
  return (
    ...
    <Accordion isCompact className="flex flex-col h-full p-4 border rounded-lg shadow-md text-lg font-medium mb-4">
      ...
      <AccordionItem className="text-xl font-semibold mb-2" key="2" aria-label="Web y Multimedia Developer | We Are Angular" title="Web y Multimedia Developer | We Are Angular">
        <p className="text-sm">- Diseño y desarrollo de landings en Wordpress <br/>- Lider implementación Frontend de LMS en CANVAS para un proyecto de educación en agricultura para usuarios en 
    paises de San Salvador, Honduras y Guatemala; Diseño Experiencia de usuario, Obtención de datos con API, Creación de modulos, Registros CSV, implementación HTML y CSS.
    ...
    -Brinde apoyo en el diseño y prototipado realizando modificaciones en las interfaces de los cursos e implementarlos en la aplicación mediante codigo HTML y CSS tanto para agricultores como Extensionistas</p>
      </AccordionItem>
      </Accordion>
