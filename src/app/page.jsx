...
export default function Home() {
  return (
      ...
      <div className='mx-4 md:mx-12 lg:mx-20 xl:mx-80 md:mb-10'>
          ...
          <h1 className="text-custom-blue Title text-4xl mb-3 mt-9 md:text-7xl font-bold  font-['Archivo'] md:mt-16 md:mb-6">Product{""} <span className="UX">Designer</span><br></br>Frontend Developer</h1>
