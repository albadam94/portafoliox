...
export default function Home() {
  return (
      ...
      <div className=' mx-4 md:mx-12 lg:mx-20 xl:mx-80 md:mb-10'>
          <div className="text-center md:mt-28 font-['Outfit']">
          <h1 className="text-custom-blue Title text-4xl mb-3 mt-9 md:text-8xl font-bold    md:mt-16 md:mb-6">Product{""} <span className="UX">Designer</span><br></br></h1>          
         ...
         <h1 id='Proyectos' className="text-custom-blue text-5xl font-semibold font-['Outfit'] leading-normal  text-center md:text-left md:mt-10 lg:mt-64 mt-20">Proyectos</h1>
